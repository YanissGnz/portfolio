  ...
  return (
    <motion.nav
      ...
      className={cn(
        ...
        scrolled
          ? "py-3 bg-nav-bg backdrop-blur-xl border-b border-border/50"
          : "py-5 bg-transparent"
      )}
    >
      ...
      <AnimatePresence>
        {mobileOpen && (
          <motion.div
            ...
            className="md:hidden absolute top-full left-0 right-0 bg-nav-bg backdrop-blur-xl border-b border-border/50 overflow-hidden"
          >
